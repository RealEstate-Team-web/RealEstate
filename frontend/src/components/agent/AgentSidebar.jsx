...
const navItems = [
  ...
  { label: 'My Properties', path: '/agent/properties', icon: Building2, disabled: true },
  { label: 'Add Property', path: '/agent/properties/new', icon: PlusCircle, disabled: true },
  { label: 'Sold / Rented', path: '/agent/properties/completed', icon: CheckCircle2, disabled: true },
